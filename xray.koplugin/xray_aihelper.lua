...
function AIHelper:loadSettings()
    ...
    if not settings.language then
        ...
        if ko_lang then
            ...
            local supported = { en=1, de=1, fr=1, ru=1, zh_CN=1, ja=1, tr=1, pt_br=1, es=1, uk=1, hu=1, nl=1, pl=1, id=1, ar=1, it=1, sr=1 }
...
-- (',', '}', ']', or ':') the quote is a genuine string terminator; otherwise
