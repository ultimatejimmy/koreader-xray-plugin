...
function Localization:t(key, ...)
    ...
    if not translation or translation == "" then
        ...
        local fallbacks = {
            ...
            series_index_unknown = "This book is in a series, but the volume number is unknown.\nUse Series Context → Link prior books… to pick the previous volumes.",
            menu_fetch_series_context = "Fetch / Refresh Series Context",
            menu_link_prior_books = "Link prior books…",
            menu_clear_series_links = "Clear series links",
            series_link_name_title = "Series name",
            series_link_name_hint = "e.g. Les Rois Maudits",
            series_link_name_required = "Enter a series name.",
            series_link_no_document = "Open a book first.",
            series_link_picker_header = "Prior books in this folder",
            series_link_none_nearby = "No other X-Ray caches in this folder.",
            series_link_add_other = "Add another book…",
            series_link_import = "Import selected",
            series_link_choose_file = "Choose a prior book",
